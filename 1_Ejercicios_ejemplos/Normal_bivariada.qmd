---
title: "Distribución Normal Bivariada"
lang: es
---
...
- $E(X)=\mu_1$, $E(Y)=\mu_2$ son números reales cualesquiera
- $\sigma_1 > 0$, $\sigma_2 > 0$, son respectivamente las desviaciones estándar de $X$ y $Y$ 
- $-1 < \rho < 1$ es el coeficiente de correlación entre $X$ y $Y$
...
for (i in seq_along(casos_ejemplo)) {
  ...
  p_contorno <- ggplot(datos$grid, aes(x = x, y = y, z = z)) +
    ...
    labs(
      title = nombre,
      subtitle = paste0("μ1=", params$mu1, ", μ2=", params$mu2, 
                       ", σ1=", params$sigma1, ", σ2=", params$sigma2,
                       ", ρ=", params$rho),
      x = "X", y = "Y",
      fill = "Densidad"
    ) +
